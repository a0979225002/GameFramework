 ...
 * @Version 1.1
 */
declare class NormalBurredImageTemplate<T extends fcc.NormalBurredImageSetting> extends NormalTemplate<T> {
    /**
     * 所有模糊圖標
