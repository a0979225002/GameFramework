...
/// <reference path="../Process/SlotProcessManager.ts" />
/// <reference path="../Scene/SceneManager.ts" />
/// <reference path="../Slot/SlotStyleManager.ts" />
/// <reference path="../WebRequest/WebRequestManager.ts" />
/// <reference path="../WebResponse/WebResponseManager.ts" />
...
namespace fcc {
    ...
    export class SlotConfigManager implements IF.ISlotConfigManager {
         ...
         * @private
         */
        private _userBet: IF.IUserBetPoint;
         ...
         * @private
         */
        private _language: type.LanguageType;
        /**
         * 返回首頁URL
         */
         ...
         * @returns {this}
         */
        setUserBet(lineBet: IF.IUserBetPoint | number) {
         ...
         * @returns {this}
         */
        setAutoCont(type: type.AutoType) {
         ...
         * @returns {this}
         */
        setLanguage(languageType: type.LanguageType): this {
...
// get -----------------------------------------------------------------
        ...
        get language(): type.LanguageType {
