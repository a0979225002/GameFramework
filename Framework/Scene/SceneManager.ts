...
import {SceneStyleType, SceneDirectionType} from './Enum/SceneStyleType'
...
export default class SceneManager implements ISceneManager {
    ...
    private style: SceneStyleType | ISceneStyle;
    ...
    private constructor(configManager: IConfigManager) {
        ...
        this.style = SceneStyleType.HORIZONTAL;                                         //初始預設scene畫面調整的模式
    }
     ...
     * @return {this}
     */
    updateSize(style?: SceneStyleType | ISceneStyle): this {
        if (style) {
            this.style = style;
            switch (style) {
