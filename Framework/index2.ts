...
/// <reference path="./Slot/SlotStyleManager.ts" />
     ...
     * @private
     */
    export let configMgr: fcc.IF.IConfigManager = fcc.SlotConfigManager.instance;
     ...
     * @private
     */
    export let animationMgr :fcc.IF.IAnimationManager;
     ...
     * @private
     */
    export let audioMgr : fcc.IF.IAudioManager;
     ...
     * @private
     */
    export let errorMgr: fcc.IF.IErrorManager;
     ...
     * @private
     */
    export let languageMgr: fcc.IF.ILanguageManager;
     ...
     * @private
     */
    export let eventMgr: fcc.IF.IEventManager;
     ...
     * @private
     */
    export let loadMgr: fcc.IF.ILoadResManager;
     ...
     * @private
     */
    export let processMgr: fcc.IF.IProcessManager;
     ...
     * @private
     */
    export let sceneMgr: fcc.IF.ISceneManager;
     ...
     */
    export let slotStyleMgr : fcc.IF.ISlotStyleManager;