...
// namespace fcc {
//
//     export class NoLineSlot<T extends IF.ISlotSetting> extends ABS.ASlot {
//
//         /**
//          * 一般停止最少轉動次數
//          * @type {number}
...
//
//         constructor(styleData: T, configManager: IF.IConfigManager) {
...
//             if (ProcessManager.instance.gameState === GameState.FREEING) {
