...
declare namespace fcc {
    namespace type {
         ...
         * @Author XIAO-LI-PIN
         * @Description 各種錯誤類型
         * @Date 2022/8/29 上午11:51:29
         * @Version framework-2.0.0 : 1.3.5
         */
        enum ErrorType {
            /**
             * 參數錯誤
...
declare namespace fcc {
    namespace global {
        ...
        class Button {
            ...
            /**
             * 對多個button添加同一個監聽事件
             * @param {Array<cc.Button>} buttons - 多個按鈕組件
             * @param {string} methodName - 該按鈕綁定的方法名稱
             * @param self - 該方法存在的位置
             * @param customEventData - 回傳值
             */
            static addButtonsEvent(buttons: Array<cc.Button>, methodName: string, self: any, customEventData?: any): void;
            /**
             * 禁用button
             * @param {cc.Button} button - 按鈕組件
             */
...
declare namespace fcc {
    namespace IF {
         ...
         * @Date 2022/8/29 上午11:51:29
         * @Version framework-2.0.0 : 1.3.5.3
         */
