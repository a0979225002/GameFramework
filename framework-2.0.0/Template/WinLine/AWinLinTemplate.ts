...
export default abstract class AWinLinTemplate extends AGenericTemplate {
    ...
    protected start() {
        ...
        fcc.nodePoolMgr.init(WIN_LINE_PARTICLE_NODE_POOL,this.particlePrefab,3)
    }
    ...
    public clear() {
        ...
        for (let i=0;i< lineLength;i++) {
            this._lineContainer.children[0].active = false;
            this._lineContainer.children[0].height = 0;
            cc.Tween.stopAllByTarget(this._lineContainer.children[0]);
        ...
        for (let i=0;i< particleLength;i++) {
            cc.Tween.stopAllByTarget(this._particleContainer.children[0]);
            this._particleContainer.children[0].getComponent(cc.ParticleSystem).resetSystem();
