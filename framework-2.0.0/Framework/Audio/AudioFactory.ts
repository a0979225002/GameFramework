...
namespace fcc {
     ...
     * @Version 1.1
     */
    export class AudioFactory implements IF.IAudioFactory {
        ...
        private readonly effectData: Map<string, Map<string, string | type.AudioStateType | boolean | number>>;
        private musicNormalData: Map<string, string | boolean | number>;
        private effectNormalData: Map<string, string | type.AudioStateType | boolean | number>;
        private musicController: MusicController
        private effectController: EffectController
        private audioManager: IF.IAudioManager;
        ...
        constructor(audioManager: IF.IAudioManager, configManager: IF.IConfigManager) {
            ...
            this.effectData = new Map<string, Map<string, string | type.AudioStateType | boolean | number>>();   //初始享元模式的效果音效
        ...
        public settingEffect(name: string,
                             canSuperimpose: type.AudioStateType = type.AudioStateType.NOT_PLAYING,
                             volume: number = this.musicVolume,
                             loop: boolean = this.loop) {

            let data: Map<string, string | type.AudioStateType | boolean | number> = new Map<string, string | type.AudioStateType | boolean | number>();
